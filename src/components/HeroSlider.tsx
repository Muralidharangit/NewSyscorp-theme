    ...
    <>
      ...
      <section className="relative w-full overflow-hidden bg-[#020826] pt-20 pb-32">
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
          ...
          <h1 className="mx-auto mb-6 max-w-4xl text-4xl font-bold tracking-tight text-white md:text-6xl lg:leading-[1.15]">
          ...
          <button className="rounded-full bg-blue-500 px-10 py-4 text-lg font-bold text-white transition-all hover:bg-blue-600 hover:shadow-[0_0_20px_rgba(59,130,246,0.5)] active:scale-95">
            Contact us!
          </button>
        </div>
      </section>
      ...
      <div className="relative z-20 -mt-24 px-6">
        <div className="mx-auto max-w-6xl overflow-hidden rounded-[2.5rem] shadow-2xl border-8 border-white/5 bg-gray-900">
          <Image
